...
public class TesServiceTestIgnoreGroupMembership {
    ...
    private User user = User.builder("123").teskMemberedGroups(emptyCollection).teskManagedGroups(emptyCollection).teskAdmin(false).build();
    ...
    public void setUp() {
        ...
        authorisationProperties.setIgnoreGroupMembership(true);
    }
    ...
    private V1JobList resultList() {
        ...
        jobList.setItems(Arrays.asList(new V1Job().metadata(new V1ObjectMeta().putLabelsItem(LABEL_USERID_KEY, "123")),
                new V1Job().metadata(new V1ObjectMeta().putLabelsItem(LABEL_USERID_KEY, "124")),
                new V1Job().metadata(new V1ObjectMeta().putLabelsItem(LABEL_USERID_KEY, "123")),
                new V1Job().metadata(new V1ObjectMeta().putLabelsItem(LABEL_USERID_KEY, "124")),
                new V1Job().metadata(new V1ObjectMeta().putLabelsItem(LABEL_USERID_KEY, "123"))));
        return jobList;
    }
